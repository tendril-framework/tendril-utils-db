...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-utils-db',
    project_urls={
        'Documentation': 'https://tendril-utils-db.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-utils-db/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-utils-db',
    },
